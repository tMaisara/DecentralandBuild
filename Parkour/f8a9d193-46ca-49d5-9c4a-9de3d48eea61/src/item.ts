...
export default class Button implements IScript<Props> {
  openClip = new AudioClip('f8a9d193-46ca-49d5-9c4a-9de3d48eea61/sounds/open.mp3')
  closeClip = new AudioClip('f8a9d193-46ca-49d5-9c4a-9de3d48eea61/sounds/close.mp3')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    door.addComponent(new GLTFShape('f8a9d193-46ca-49d5-9c4a-9de3d48eea61/models/Chest_Pirates.glb'))
