...
export default class Button implements IScript<Props> {
  ...
  clip = new AudioClip('637c0746-3aa0-4e08-8dc0-3aa1f15eeb84/sounds/use.mp3')
  canvas = new UICanvas()
  container = new UIContainerStack(this.canvas)
  texture = new Texture('637c0746-3aa0-4e08-8dc0-3aa1f15eeb84/images/Key.png')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    key.addComponent(new GLTFShape('637c0746-3aa0-4e08-8dc0-3aa1f15eeb84/models/Gem_Key_Fantasy.glb'))
    key.addComponent(
           new OnPointerDown(() => {
