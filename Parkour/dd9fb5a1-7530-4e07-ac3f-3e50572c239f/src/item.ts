...
export default class Button implements IScript<Props> {
  openClip = new AudioClip('dd9fb5a1-7530-4e07-ac3f-3e50572c239f/sounds/open.mp3')
  closeClip = new AudioClip('dd9fb5a1-7530-4e07-ac3f-3e50572c239f/sounds/close.mp3')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    door.addComponent(new GLTFShape('dd9fb5a1-7530-4e07-ac3f-3e50572c239f/models/Chest_Genesis.glb'))
