...
export default class Button implements IScript<Props> {
  ...
  clip = new AudioClip('64c448a3-f69c-4bce-b9f4-5bb5f0669084/sounds/use.mp3')
  equipClip = new AudioClip('64c448a3-f69c-4bce-b9f4-5bb5f0669084/sounds/KeyEquip.mp3')
  canvas = new UICanvas()
  container = new UIContainerStack(this.canvas)
  texture = new Texture('64c448a3-f69c-4bce-b9f4-5bb5f0669084/images/Key.png')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    key.addComponent(new GLTFShape('64c448a3-f69c-4bce-b9f4-5bb5f0669084/models/Gold_Key_Genesis.glb'))
    key.addComponent(
      new OnPointerDown(
        () => {
