...
export default class Button implements IScript<Props> {
  ...
  clip = new AudioClip('ebfc8f37-d1cf-44a2-bca0-3bf62de01cbc/sounds/use.mp3')
  equipClip = new AudioClip('ebfc8f37-d1cf-44a2-bca0-3bf62de01cbc/sounds/KeyEquip.mp3')
  canvas = new UICanvas()
  container = new UIContainerStack(this.canvas)
  texture = new Texture('ebfc8f37-d1cf-44a2-bca0-3bf62de01cbc/images/Key.png')
